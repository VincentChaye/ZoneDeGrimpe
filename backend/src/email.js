...
export async function sendPasswordResetEmail(to, resetUrl, lang = "fr") {
  ...
  const htmlBodies = {
    fr: `<p>Bonjour,</p><p>Vous avez demandé la réinitialisation de votre mot de passe sur ZoneDeGrimpe.</p><p><a href="${resetUrl}" style="background:#5D7052;color:white;padding:10px 20px;border-radius:8px;text-decoration:none;display:inline-block">Réinitialiser mon mot de passe</a></p><p>Ce lien est valable <strong>1 heure</strong>.</p><p>Si vous n'avez pas fait cette demande, ignorez cet email.</p>`,
    en: `<p>Hello,</p><p>You requested a password reset on ZoneDeGrimpe.</p><p><a href="${resetUrl}" style="background:#5D7052;color:white;padding:10px 20px;border-radius:8px;text-decoration:none;display:inline-block">Reset my password</a></p><p>This link is valid for <strong>1 hour</strong>.</p><p>If you did not request this, please ignore this email.</p>`,
    es: `<p>Hola,</p><p>Has solicitado restablecer tu contraseña en ZoneDeGrimpe.</p><p><a href="${resetUrl}" style="background:#5D7052;color:white;padding:10px 20px;border-radius:8px;text-decoration:none;display:inline-block">Restablecer mi contraseña</a></p><p>Este enlace es válido por <strong>1 hora</strong>.</p><p>Si no solicitaste esto, ignora este correo.</p>`,
  };
